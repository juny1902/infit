    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_go_shop_from_room.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MBTIResultActivity.mbtiResultActivity.finish();
                ConceptActivity.conceptActivity.finish();
                ConceptRoomActivity.conceptRoomActivity.finish();
                TypeActivity.typeActivity.finish();
